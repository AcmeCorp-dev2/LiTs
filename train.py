...
# Add the following lines to handle multiprocessing on Windows
...
print(dataloader)
# for W,Q in enumerate(dataloader,1):
#     NetC.zero_grad()
...
for epoch in range(1, niter+1):
    for i, data in tqdm(enumerate(dataloader, 1)):
        ...
        if cuda:
            ...
            output_masked = output_masked.cpu()
        ...
        if cuda:
            ...
            target_masked = target_masked.cpu()
